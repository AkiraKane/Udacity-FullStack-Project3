...
"""
A public endpoint for getting all drink without any details
"""
@app.route("/drinks")
def get_drinks():

    # retrieve all drinks from db
    drinks_db = Drink.query.order_by(Drink.id).all()
    ...
    # returns status code 200 and json file where drinks is the list of drinks
    return jsonify({
        "success": True,
        "drinks": drinks
    })
...
"""
A private endpoint for getting all drink with all details
"""
...
"""
A private endpoint for posting drinks
"""
...
"""
A private endpoint for patching a drink by a given id
"""
...
"""
A private endpoint for deleting a drink by given id
"""
